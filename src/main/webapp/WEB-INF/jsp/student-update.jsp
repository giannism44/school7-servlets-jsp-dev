...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header bg-red-800 text-white">
            <h4 class="mb-0"><i class="fas fa-user-edit me-2">Επεξεργασία Μαθητή</i></h4>
        </div>
        <div class="card-body">
            <form method="POST" action="${pageContext.request.contextPath}/school-app/students/update">
                ...
                <div class="d-flex justify-content-between">
                    <a href="${pageContext.request.contextPath}/school-app/students/view" class="btn btn-outline-secondary">
