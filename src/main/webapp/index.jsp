            ...
            <div class="space-y-8">
                ...
                <div class="mt-10">
                    <a href="${pageContext.request.contextPath}/login"
                       class="inline-flex items-center px-8 py-3 border border-transparent text-lg font-medium rounded-md shadow-sm text-white bg-red-800 hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-danger-8  00 transition-all duration-200 transform hover:scale-105">
                        Συνέχεια
